...
/* MaskPass + ClearMaskPass stubs */
class MaskPass extends Pass{ constructor(s,c){super();this.scene=s;this.camera=c;this.needsSwap=false} render(){}}
class ClearMaskPass extends Pass{ constructor(){super();this.needsSwap=false} render(renderer){if(renderer.state&&renderer.state.buffers&&renderer.state.buffers.stencil){renderer.state.buffers.stencil.setLocked(false);renderer.state.buffers.stencil.setTest(false)}}}
